...
export class ContentController {
    ...
    @Post('/')
    async createContent(@Res() res: Response, @Body() contentInfo: CreateContentDto) {
        try {
    ...
    @Put()
    async updateContent(@Res() res: Response, @Body() contentInfo: UpdateContentDto) {
        try {
    ...
    @Delete('/:content_id')
    async deleteContent(@Res() res: Response, @Param('content_id') content_id: string) {
        try {
    ...
    @Get('/:content_id')
    async getContentInfo(@Res() res: Response, @Param('content_id') content_id: string) {
        try {
